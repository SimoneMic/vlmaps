...
class VLMapBuilderROS(Node):
    ...
    #def pc2_to_numpy(self, msg: PointCloud2):
    #    if msg.data is not None:
    #        # Parse the PointCloud2 message
    #        gen = sensor_msgs_py.point_cloud2.read_points(msg, field_names=("x", "y", "z"), skip_nans=True)
    ...
    def sensors_callback(self, img_msg, depth_msg):
        ...
        self.get_logger().info('Evaluation of each point in the PC and projection into map')
